...
public class ModeLever extends Module {
   ...
   private final Setting<ModeLever.TopMode> topPlacement;
   ...
   public ModeLever() {
      super(Categories.NewCombat, "Mode-button", "to put button for breaking through");
      ...
      this.topPlacement = this.sgplac.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("placing")).description("where to put?")).defaultValue(ModeLever.TopMode.Surround)).build());
      this.rotate = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("rotate")).description("Rotates towards blocks when placing.")).defaultValue(false)).build());
      this.blocks = this.sgGeneral.add(((BlockListSetting.Builder)((BlockListSetting.Builder)(new BlockListSetting.Builder()).name("blocks")).description("What blocks to use for surround.")).defaultValue(class_2246.field_10494).filter(this::blockFilter).build());
   ...
   private void onTick(TickEvent.Pre event) {
      FindItemResult obsidian = InvUtils.findInHotbar(class_1802.field_8781);
   ...
   private void fillPlaceArray(class_1657 target) {
      ...
      switch((ModeLever.TopMode)this.topPlacement.get()) {
      case Surround:
   ...
   private boolean blockFilter(class_2248 block) {
      return block == class_2246.field_10494 || block == class_2246.field_10057 || block == class_2246.field_10417 || block == class_2246.field_22101 || block == class_2246.field_10278;
   }
   ...
   public static enum TopMode {
      ...
      // $FF: synthetic method
      private static ModeLever.TopMode[] $values() {
         return new ModeLever.TopMode[]{Surround, OnSurround, LongSurround, kickSelfTrap, kickSurround};
      }
   }
}
