...
public class ModeFier extends Module {
   ...
   private final Setting<ModeFier.TopMode> topPlacement;
   ...
   public ModeFier() {
      super(Categories.NewCombat, "Mode-Rocket", "blows up the opponent / prevents the opponent from putting up protection");
      ...
      this.delay = this.sgGeneral.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name("place-delay")).description("How many ticks between block placements.")).defaultValue(4)).build());
      ...
      this.topPlacement = this.sgplac.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("placing")).description("where to put?")).defaultValue(ModeFier.TopMode.Player)).build());
   ...
   private void onTick(TickEvent.Pre event) {
      FindItemResult obsidian = InvUtils.findInHotbar(class_1802.field_8639);
   ...
   private void fillPlaceArray(class_1657 target) {
      ...
      switch((ModeFier.TopMode)this.topPlacement.get()) {
      case Player:
         this.add(targetPos.method_10069(0, 0, 0));
         break;
      case Surround:
   ...
   public static enum TopMode {
      ...
      // $FF: synthetic method
      private static ModeFier.TopMode[] $values() {
         return new ModeFier.TopMode[]{Player, Surround};
      }
   }
}
